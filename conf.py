...
BLOG_AUTHOR = "Куднуруб Бурундук"  # (translatable)
BLOG_TITLE = "Пространство Бурундука"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://burunduk.space/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://burunduk.space/"
BLOG_EMAIL = "kudnurub@burunduk.space"
BLOG_DESCRIPTION = "Алгоритмы, задачки и проч. проч."  # (translatable)
